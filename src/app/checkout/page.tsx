              ...
              <>
                ...
                {wilayaCode && (
                  <p className="text-sm text-brand-purple font-bold">
                    سعر التوصيل: {deliveryPrice.toLocaleString("en-US")} دج
                  </p>
                )}
              </>
            )}
          ...
          <div className="card-surface p-5 sticky top-24">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center justify-between text-brand-purple-dark/70">
                ...
                <span>{itemsTotal.toLocaleString("en-US")} دج</span>
              </div>
              <div className="flex items-center justify-between text-brand-purple-dark/70">
                <span>التوصيل</span>
                <span>{deliveryMethod === "pickup" ? "مجاني" : `${deliveryPrice.toLocaleString("en-US")} دج`}</span>
              </div>
            </div>

...
export default function ProductDetailPage() {
  ...
  const handleAdd = () => {
    ...
    if (hasVariants && !selectedVariant) {
      toast.error("يرجى اختيار الرائحة/اللون أولاً");
      return;
    }
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div>
          ...
          {hasVariants && (
            <div className="mb-5">
              <p className="text-sm font-bold text-brand-purple-dark mb-2">
                اختاري الرائحة/اللون *
              </p>
              <div className="flex flex-wrap gap-2">
                {product.variants!.map((v) => (
                  <button
                    ...
                    className={`px-4 h-10 rounded-full border-2 text-sm font-bold transition-colors ${
                      selectedVariant === v
